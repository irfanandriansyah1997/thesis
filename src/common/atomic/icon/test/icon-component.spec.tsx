...
describe('Testing icon component in atomic component ', () => {
    ...
    it('Test render icon specific padding', () => {
        const icon = render(
            <IconComponent
                color="info100"
                size={16}
        ...
        expect(icon.prop('style')).toHaveProperty('padding-top', '5px');
        expect(icon.prop('style')).toHaveProperty('padding-right', '5px');
        expect(icon.prop('style')).toHaveProperty('padding-bottom', '5px');
        expect(icon.prop('style')).toHaveProperty('padding-left', '5px');
    });
});
